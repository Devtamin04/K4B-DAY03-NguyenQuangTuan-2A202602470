...
class MCPAcademicServer:
    ...
    """
    def __init__(self, server_name: str = "vinfast-emotorbike-service-mcp-server"):
...
if __name__ == "__main__":
    print("==========================================================")
    print("🔌 KIỂM THỬ ĐỘC LẬP MCP SERVER (vinfast-emotorbike-service-mcp-server)")
    print("==========================================================")
    ...
    sched_tool = next((t for t in tools if t.get("name") == "book_service_appointment"), None)
    if sched_tool and not sched_tool.get("parameters", {}).get("properties"):
        print("⏳ [TODO 1.2]: Tool 'book_service_appointment' chưa được định nghĩa properties trong 'src/tools.py'.")
    else:
        print("✅ [TODO 1.2]: Tool 'book_service_appointment' đã có schema đầy đủ.")

    # Kiểm tra trạng thái TODO 2.1 (call_tool)
    test_result = server.call_tool("check_vehicle_history", {"plate_number": "29MĐ1-12345"})
    if not test_result:
        print("⏳ [TODO 2.1]: Hàm call_tool() đang trả về rỗng. Học viên hãy hoàn thiện TODO 2.1 trong 'src/mcp_server.py'!")
    else:
        print(f"✅ [TODO 2.1]: Test dispatch tool 'check_vehicle_history' thành công:")
